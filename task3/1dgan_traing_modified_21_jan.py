...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 21 20:07:38 2020
...
data = np.load('/home/sarfaraz/Desktop/isro@internship/task3/stacked_june24_false_npy.npy')
gt2 = np.load('/home/sarfaraz/Desktop/isro@internship/task3/stacked_june19_true_npy.npy')
gt = gt2[:,:,0]
...
#        d_loss_real = d_model.fit(X_real, [y_real, labels_real])
