...
data = np.load('/home/sarfaraz/Desktop/isro@internship/task3/stacked_june19_false_npy.npy')
gt2 = np.load('/home/sarfaraz/Desktop/isro@internship/task3/stacked_june24_true_npy.npy')
gt = gt2[:,:,0]
